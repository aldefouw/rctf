Feature: Well Formed Dialog selection

  As a REDCap tester
  I want to see that I can interact with well-formed HTML properly

  Scenario: Go to Well Formed HTML page
    Given I click on the link labeled "Well Formed Dialog"
    Then I should see "Well Formed Dialog"
...
#    Then I should see a checkbox labeled "Checkbox 1" that is checked in the dialog box
#    And I should see a checkbox labeled "Checkbox 2" that is checked in the dialog box
