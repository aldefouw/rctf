Feature: Spreadsheet tests
  ...
  Scenario: Go to Spreadsheet HTML page
    ...
    And the downloaded CSV with filename "test.csv" should have the header and rows below
      ...
      | 300       | Paul   | paul@noreply.edu   | 2                        | Ringo  | 7/7/40  | drummer | The Beatles were an English rock band formed in Liverpool in 1960. | 1                      | 7                        | 3                   | 100                 | 1            | 1            | 1            | 8675309  | 123-45-6789    | 555-555-5555     | 5      | 2                   | 0                             |       |                         |
